...
| `fr3_dual_bolt_cell/model.py` | 生成完整 URDF、SRDF、ros2_control、MoveIt 配置，防止左右配置漂移 |
...
| `/left_gripper_controller/gripper_cmd`、`/right_gripper_controller/gripper_cmd` | 两只夹爪 GripperCommand action |
