...
def test_initial_pose_is_mirrored_and_grippers_clear_of_upper_arms():
    ...
    for left_suffix, right_suffix in (('gripper_left_finger_link', 'gripper_right_finger_link'),
                                      ('gripper_right_finger_link', 'gripper_left_finger_link')):
    ...
    for side in ('left', 'right'):
        for arm_link in (f'{side}_upperarm_link', f'{side}_forearm_link'):
            for gripper_link in (f'{side}_gripper_base_link',
                                 f'{side}_gripper_left_finger_link',
                                 f'{side}_gripper_right_finger_link'):
